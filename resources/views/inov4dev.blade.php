...
<body class="h-screen bg-black text-white">
    ...
    <nav class="flex flex-wrap sm:flex-nowrap w-full relative">
        ...
        <div class="flex w-full ">
            ...
            <div
                class= "flex bg-white py-8 lg:px-8 justify-center lg:justify-start text-center text-slate-900 border-b-2 border-black w-full">

                <span
                    class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-black relative inline-block">
                    <span class="relative text-5xl justify-center font-jhetegral text-white">Walysson dos
                        Reis</span>
                </span>
            </div>
        </div>
        {{-- Itens da navbar --}}
        <div
            class="absolute sm:relative left-0 top-full sm:block justify-start p-4 w-48 sm:w-full text-black items-center bg-white border-black shadow-lg sm:shadow-none sm:border-b-2 rounded-br-md sm:rounded-none ">
            <ul class="flex flex-wrap sm:flex-nowrap w-full text-lg">
                <li
                    ...
                    <span class="italic font-nexal text-2xl align-middle pr-2">
                        <>
                    </span> inicio
                </li>
                <li
    ...
    <div class="flex container mx-auto p-4  justify-center">
        ...
        <div class="flex-col shadow-md bg-white text-black text-center p-4 rounded-xl justify-center">
            <div class="flex flex-wrap lg:text-9xl text-7xl justify-center p-4 font-nexah"> INOV <span
                    class="text-blue-600">4</span> DEV</div>
    ...
    <div class="container mx-auto flex-col justify-center p-4">
        ...
        <div class="flex flex-wrap sm:flex-nowrap border-2 border-white rounded-md p-4 justify-center w-full">
            ...
            <div class="flex p-4 text-justify font-nexal font-semibold">
                <p>
                    Olá! Eu sou Walysson Pereira dos Reis, um desenvolvedor web apaixonado por tecnologia. Ao longo da
                    minha carreira, desenvolvi uma mentalidade analítica e resolutiva que me permitiu superar inúmeros
                    desafios. Com uma curiosidade incessante, busco aprimorar-me e aplicar as últimas tendências no
                    desenvolvimento. Estou sempre pensando em contribuir para projetos inovadores, transformando
                    concepções em realidade e buscando equilíbrio entre eficiência e elegância no design de software.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto flex-col justify-center p-4 ">
        <div class="flex justify-center p-4">
            <span class="font-nexal sm:text-4xl text-3xl p-4"> <i>
                    <> FULLSTACK <&sol;>
                </i></span>
        </div>
        <div class="flex-col justify-center p-4">
            <div class="flex flex-wrap justify-center">
                ...
                <div class="flex-col border-2 border-white p-4 max-w-md">
                    ...
                    <div class="flex text-sm text-justify">
                        <p>
                            Vue.js é um framework JavaScript progressivo e de código aberto que simplifica o
                            desenvolvimento de interfaces de usuário (UI) em aplicações web. Sua abordagem incrementável
                            facilita a integração em projetos existentes, enquanto suas características, como
                            reatividade, componentização e diretivas, promovem eficiência e manutenção simplificada do
                            código. Com uma comunidade ativa, documentação robusta e desempenho eficiente, Vue.js
                            destaca-se como uma escolha sólida para desenvolvedores que buscam uma experiência de
                            desenvolvimento web flexível e poderosa.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container mx-auto flex justify-center flex-wrap sm:flex-nowrap p-4">
        ...
        <div class="flex-col p-4 justify-center border-2 border-white rounded-md sm:order-1 w-full sm:w-1/2">
            <div class="flex-col text-black p-2 justify-center">
                <label class="flex text-white p-1 " for="nome_input">Nome</label>
                <input class="flex text-black p-2 rounded-md border-2 border-gray-300 w-full" type="text"
                    id="nome_input">
            </div>
            <div class="flex-col text-black p-2 justify-center">
                <label class="flex text-white p-1" for="email_input">Email</label>
                <input class="flex text-black p-2 rounded-md border-2 border-gray-300 w-full" type="email"
                    id="email_input">
            </div>
            <div class="flex-col text-black p-2 justify-center">
                <label class="flex text-white p-1" for="mensagem_input">Mensagem</label>
                <textarea class="flex text-black p-2 rounded-md border-2 border-gray-300 w-full" name="" id="mensagem_input"
                    cols="" rows="5"></textarea>
            </div>
            <div class="flex p-2 justify-center">
                <button class="bg-white text-black rounded-md px-10 py-1"> Enviar</button>
            </div>
        </div>
    </div>
    {{-- Container Redes sociais --}}
    <div class="container mx-auto flex flex-wrap sm:flex-nowrap justify-center p-4">
        <div class="flex p-4">
        ...
        <div class="flex justify-center gap-2 items-center p-4">
            {{-- GitHub --}}
            <a class="w-10" href="https://github.com/walyssondosreis" target="blank">
            ...
            {{-- LinkedIN --}}
            <a class="w-10" href="https://www.linkedin.com/in/walysson-dos-reis-3ba2b8232/" target="blank">
            ...
            {{-- Instagram --}}
            <a class="w-10 fill-white" href="https://www.instagram.com/walyssondosreis/" target="blank">
            ...
            {{-- Twitter --}}
            <a class="w-10" href="https://twitter.com/walyssondosreis" target="blank">
            ...
            {{-- Telegram --}}
            <a class="w-10" href="https://t.me/inov4dev" target="blank">
            ...
            {{-- Whatsapp --}}
            <a class="w-10 fill-white" href="https://wa.me/5538988701544" target="blank">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 737.509 740.824">
