                    ...
                    <Menu as="div" class="relative ml-3">
                        <div>
                            <MenuButton
                                ...
                                <img class="h-8 w-8 rounded-full" src="../../../public/images/pika.jpg" alt="" />
                            </MenuButton>
                        </div>
...
const navigation = [
    ...
    { name: 'Atualizar via API', href: '/atualizar?modo=api', current: false },
    { name: 'Atualizar via CSV', href: '#', current: false },
    { name: 'Painel', href: '#', current: false },
