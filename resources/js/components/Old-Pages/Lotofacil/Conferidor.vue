<template>
    ...
    <div class="flex justify-center flex-wrap">
        <div class="flex-col lg:w-4/6 p-4 w-full order-2 lg:order-1">
            <!-- Aqui Componente de card conferencia -->

        </div>

        <div class="flex-col lg:w-2/6 p-4 w-full order-1 lg:order-1">

            <!-- Aqui componente de ranking -->

        </div>

        <div class="flex justify-center bg-gray-300 w-full p-4">
